...
const inputHowManyInputs: HTMLInputElement = document.querySelector('#input5');
const deleteButton: HTMLButtonElement = document.querySelector('#deleteButton');
const declareButton: HTMLButtonElement = document.querySelector('#declareButton');
...
deleteButton.addEventListener('click', () => {
    ...
    inputHowManyInputs.value = (elementsArray.length).toString();
